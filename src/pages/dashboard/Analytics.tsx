...
const Analytics: React.FC = () => {
  const { dashboardMetrics, jobMetrics, isLoading, error, refreshMetrics } = useAnalytics();
  ...
  if (!dashboardMetrics?.jobMetrics?.length) {
    return (
      <div className="py-6">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Start posting jobs and receiving applications to see analytics.
            </p>
          </div>
        </div>
      </div>
